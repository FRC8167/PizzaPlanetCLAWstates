...
public final class Constants {
  ...
  public static final double DRIVETRAIN_LIMIT_SNAIL = 0.4;
  public static final double DRIVETRAIN_LIMIT_NOMINAL = 0.8;
  public static final double DRIVETRAIN_LIMIT_FAST = 0.95;

  public static final double TRACKED_TAG_AREA_KP = 0.2;
  public static final double CAMERA_HEIGHT_METERS = Units.inchesToMeters(27.0);
  public static final double TARGET_HEIGHT_METERS = Units.inchesToMeters(0.0);
  ...
  public static final double COUNTS_TO_DEGREES = 0.076089934;
