...
public class RobotContainer {
  ...
  public static PowerDistribution _pdm;
  public static final CommandXboxController driverController = new CommandXboxController(Constants.DRIVER_CONTROLLER);
  ...
  public RobotContainer() {
    ...
    configureBindings();
    addAutoCommands();
    _pdm = new PowerDistribution();
    SmartDashboard.putData(autoCommandSelector);
    drivetrain.setDefaultCommand(new ArcadeDrive(
      drivetrain, 
      () -> driverController.getLeftY()*1, //.80,
  ...
  private void configureBindings() {
   ...
   // m_driverController.b().whileTrue(m_exampleSubsystem.exampleMethodCommand());
    ...
    extremeController.button(7).onTrue(new AcquireGamePiece(64, 10.0, m_pivot_MM, m_arm_MM, grabber));
    //HUMAN PLAYER
    ...
    extremeController.button(10).onTrue(new NestArm(2.0, 1.0, m_pivot_MM, m_arm_MM));
    //NEST
  ...
  private void addAutoCommands()  {
    autoCommandSelector.setDefaultOption(
      ...
      new SequentialCommandGroup(
        new Pivot_To_Setpoint(74, m_pivot_MM).withTimeout(1.5),
        new WaitCommand(0.1),
        ...
        new WaitCommand(0.1),
        new InstantCommand(() -> grabber.closeGrabber()).withTimeout(0.1),
        new WaitCommand(0.0),
    ...
    autoCommandSelector.addOption(
      ...
      new SequentialCommandGroup(
        ...
        new WaitCommand(0.0),
        new ParallelCommandGroup(
          new Pivot_To_Setpoint(5.0, m_pivot_MM).withTimeout(0.3),
          new DriveForwardDistance(drivetrain, -15.5)
        ),
        new WaitCommand(0.0),
        new DriveForwardDistance(drivetrain,7),
        new WaitCommand(0.0),
        new ChargingStationAutoBalance(drivetrain)
      )
    );
    ...
    autoCommandSelector.setDefaultOption(
      "CP",
      new SequentialCommandGroup(
        new Pivot_To_Setpoint(72.5, m_pivot_MM).withTimeout(1.5),
        new WaitCommand(0.1),
        new Arm_To_Setpoint(35, m_arm_MM),
        new WaitCommand(0.0),
        new InstantCommand(() -> grabber.openGrabber()),
    ...
    autoCommandSelector.addOption(
      ...
      new SequentialCommandGroup(
        ...
        new ParallelCommandGroup(
          new Pivot_To_Setpoint(5.0, m_pivot_MM).withTimeout(0.3),
          new DriveForwardDistance(drivetrain, -16.5)
        )
        // new RotateAngle(drivetrain, 180),
        // new Pivot_to_Setpoint()
      )
    );
